...
verified_against: [BACKEND-016, SHOP-FE-011, SHOP-FE-010, SHOP-FE-009, SHOP-FE-008, BACKEND-013, SHOP-FE-001]
---
...
联调前默认先检查 `GET /health` 与 `GET /version`，确认本地后端可用；该运行基线已于 2026-03-23 文档同步时再次复核通过。
...
| `/payments/order/:orderId` | GET | 查询订单支付记录 |
